...
import chat.client.Model.ModelClient;
import chat.client.vue.VueAddClient;
import chat.client.vue.VueClient;
import chat.client.vue.VueConnexion;
...
public class ControllerClient implements ActionListener {
	...
	public ControllerClient(VueClient vue){
		...
		this.vue.addWindowListener(new WindowAdapter(){
			...
			public void windowClosed(WindowEvent e) {
				int i=JOptionPane.showConfirmDialog(ControllerClient.this.vue, "Voulez vous vraiment quitter ?", null, JOptionPane.YES_NO_OPTION);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.vue.getDeconnexion()){
			...
			int i=JOptionPane.showConfirmDialog(vue, "Voulez vous vraiment quitter ?", null, JOptionPane.YES_NO_OPTION);
